...
class _AbstractSectionTransformer(object):
    ...
    def test_class_provides(self):
        assert_that(sectionvideoadder.YouTubeRelatedVideoAdder,
                    provides(interfaces.IStaticYouTubeEmbedVideoAdder))
    ...
    def test_add_videos(self):
        ...
        util, count = result[0]
        assert_that(util, is_(same_instance(
            sectionvideoadder.YouTubeRelatedVideoAdder)))
