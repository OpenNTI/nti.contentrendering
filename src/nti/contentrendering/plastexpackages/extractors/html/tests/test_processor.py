...
class HTMLProcessTest(HTMLExtractorTests):
    ...
    def test_sidebar_with_title(self):
        script = u"""<body><div><div class="sidebar" data-ntiid="tag:nextthought.com,2011-10:IFSTA-HTML:NTISidebar-sample_book.sidebar.sidebar_title" ntiid="tag:nextthought.com,2011-10:IFSTA-HTML:NTISidebar-sample_book.sidebar.sidebar_title">
