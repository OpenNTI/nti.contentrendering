...
class MathjaxInlineCompilerDriver(converters.AbstractOneOutputDocumentCompilerDriver):
	...
	def writePreamble(self):
		...
		<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/mathjax/2.4.0/MathJax.js?config=TeX-AMS_HTML,https://s3.amazonaws.com/dev.nextthought.com/mathjaxconfig.js"></script>\
		')
